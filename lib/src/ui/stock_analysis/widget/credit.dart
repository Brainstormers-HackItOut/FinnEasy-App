...
class Credit extends StatefulWidget {
  ...
  Credit({Key? key, required this.credit}) : super(key: key);
...
class _CreditState extends State<Credit> {
  ...
  Widget build(BuildContext context) {
    ...
    for (String key in widget.credit.keys){
      chartData.add(_SalesData(key, widget.credit[key]));
    }
